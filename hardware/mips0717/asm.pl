...
'addu'   => '000000, $r2.5, $r3.5, $r1.5, 00000, 100001',
...
'bltz'   => '000001, $r1.5, 00000, $relLbl.16',
'blez'   => '000110, $r1.5, 00000, $relLbl.16',
...
'addu'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'sub'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'and'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'or'    => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'slt'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'sltu'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'sll'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'movz'   => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+',
'jr'   => '\$[0-9]+[\t\s]*',
'jalr'   => '\$[0-9]+[\t\s]*',
'rfe'   => '',
'addi'  => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\-?[0-9a-fA-FxX]+',
'addiu'  => '\$[0-9]+[\t\s]*,[\t\s]*\$[0-9]+[\t\s]*,[\t\s]*\-?[0-9a-fA-FxX]+',
...
'bltz'   => '\$[0-9]+[\t\s]*,[\t\s]*[a-zA-Z_]\w*',
'blez'   => '\$[0-9]+[\t\s]*,[\t\s]*[a-zA-Z_]\w*',
'j'     => '[a-zA-Z_]\w*',
'jal'     => '[a-zA-Z_]\w*',
