...
HD_PWD='C:/Users/Shun Kinoshita/Desktop/CompSysArch/hardware/fpga_mips/fpga_mips.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mipse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_mipse.tcl
