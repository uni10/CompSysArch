...
HD_PWD='C:/Users/Shun Kinoshita/Desktop/CompSysArch/hardware/fpga_mips/fpga_mips.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mipse.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_mipse.tcl -notrace
